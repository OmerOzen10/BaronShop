...
public class BasketAdapter extends RecyclerView.Adapter<BasketAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.basketProductPrice.setText(String.valueOf(total));
        holder.decreaseItem.setOnClickListener(view -> {
            ...
            if (allProducts.getNumber() > 1) {
                ...
                double totalAmount = Double.parseDouble(holder.basketProductPrice.getText().toString());
                double total1 = Double.parseDouble(df1.format(totalAmount - amount1));
                holder.basketProductPrice.setText(String.valueOf(total1));
            }
        });
        ...
        holder.increaseItem.setOnClickListener(view -> {
            ...
            holder.basketProductPrice.setText(String.valueOf(total12));
        });
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView basketProductPrice;
        ConstraintLayout buyConstraint, emptyConstraint;
        Button btnContinue;
